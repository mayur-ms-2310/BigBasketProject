...
productArr.map(function (elem, index) {
  ...
  delitime.innerText = "Standard Delivery By:Tommorow 1:00PM - 3:00PM";
 ...
 btn.addEventListener("click",function(){
  ...
  btnimg.setAttribute("src", "product-deck-sprite (3).png");
  btn.append(btnimg);
...
function slideShow() {
  ...
  let headline = document.getElementById("anuj");//ye wo div hai jaha image append krni hai
